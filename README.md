...
*   [heizaheiza/Charles-mcp](https://github.com/heizaheiza/Charles-mcp) - Charles Proxy MCP server for AI agents with live capture, structured traffic analysis, and agent-friendly tool contracts
...
*   [cscnk52/wechat-windows-versions](https://github.com/cscnk52/wechat-windows-versions) - Automated Archive of WeChat for Windows
...
*   [DaVinci-R/news-analysis-system](https://github.com/DaVinci-R/news-analysis-system) - 一个搭载AI的新闻分析系统，具备模块化、独立性、可拓展的特点，自动获取新闻录入数据库、借助LLM结构化处理新闻原文并保存于数据库，前端图表展示数据库内容，智能问答窗口与搭载数据库的LLM进行交互
...
*   [lixi5338619/magical\_spider](https://github.com/lixi5338619/magical_spider) - 神奇的蜘蛛🕷，一个几乎适用于所有web端站点的采集方案
...
*   [jiaeyan/chinese-rhymer](https://github.com/jiaeyan/chinese-rhymer) - 轻量中文押韵神器，100%绝对可用，傻瓜式命令行操作，秒速实现烈焰单押，闪电双押，龙卷三押以及海啸式四押，目前版本 v0.2.6。Search for rhymes for Chinese words, with 1, 2, 3 and 4 characters, released on PyPI with current version of 0.2.6.
...
*   [rehuan/AI-ANSWER-ASSISTANT](https://github.com/rehuan/AI-ANSWER-ASSISTANT) - 一个智能的浏览器答题插件，能够自动识别网页中的题目（单选、多选、填空题），通过AI大模型获取答案并自动填写。
...
*   [mswnlz/movies](https://github.com/mswnlz/movies) - 影视媒体资源，电影，记录片，音乐，演唱会等等，持续更新中

*   [Loveyless/stock-indicator-backtest](https://github.com/Loveyless/stock-indicator-backtest) - 股票量化助手，根据量化策略生成股票收益报告。
...
*   [teressalodas/Flclash-scripts](https://github.com/teressalodas/Flclash-scripts) - A repository for Flclash scripts
...
*   [sharkfly666/ai-generator-commit-message](https://github.com/sharkfly666/ai-generator-commit-message) - Git Commit Message Generator Plugin for JetBrains IDEs
...
*   [TC999/ghidra-chinese](https://github.com/TC999/ghidra-chinese) - （开发中）Ghidra 是一个软件逆向工程 (SRE) 框架。社区汉化版，原版 https://github.com/NationalSecurityAgency/ghidra

*   [kunpeng-open-project/kunpeng](https://github.com/kunpeng-open-project/kunpeng) - 昆鹏微服务快捷开发框架
...
*   [fushengqian/fuintCatering](https://github.com/fushengqian/fuintCatering) - fuint餐饮点餐营销系统，支持多租户SaaS模式，已对接扫码枪、云打印小票、标签打印，提供包括小程序扫码点餐、收银、餐食配餐、厨房kds、食材采购、餐饮卡券、积分、储值会员营销等一体化的功能，为奶茶店，甜品店，餐厅，火锅店，食堂，酒吧，咖啡厅，大排档，小吃店等实体餐饮店铺管理提供一站式解决方案。官网:https://www.fuint.cn，感谢关注！
...
*   [uncarbon97/helio-boot](https://github.com/uncarbon97/helio-boot) - helio-boot基于Spring Boot 3.x，是一款预置SaaS、RBAC能力的单体项目脚手架，适合初学者学习 JavaWeb 开发的良好实践；本项目最简仅单个Maven模块，拆分多模块版请移步至helio-boot-modular项目
...
*   [pig-mesh/deepseek4j](https://github.com/pig-mesh/deepseek4j) - deepseek java sdk
...
*   [localhost02/SealUtil](https://github.com/localhost02/SealUtil) - 印章生成工具：使用Java Graphics2D生成各类圆形/椭圆公章、私章图片

*   [yestarz/mcp-server-weather](https://github.com/yestarz/mcp-server-weather) -
...
*   [uncarbon97/helio-cloud](https://github.com/uncarbon97/helio-cloud) - helio-cloud基于 Spring Boot 3.x + Spring Cloud Alibaba 2023 + Dubbo 3，是一款预置SaaS、RBAC能力的微服务项目脚手架，助力开发者快速上手企业级微服务开发
...
*   [yy4382/ms-ra-forwarder-for-ifreetime](https://github.com/yy4382/ms-ra-forwarder-for-ifreetime) - 免费的在线文本转语音API。相比原项目增加了爱阅、源阅读等软件的支持。
...
*   [clashv2ray-hub/clashv2ray-hub.github.io](https://github.com/clashv2ray-hub/clashv2ray-hub.github.io) - clash节点、v2rayj节点，免费clash节点、免费节点、免费梯子、clash科学上网、clash翻墙、clash订阅链接、clash for Windows、clash教程、免费公益节点、最新clash免费节点订阅地址、clash免费节点每日更新

*   [Jsnzkpg/pansou](https://github.com/Jsnzkpg/pansou) - 裤佬全网盘搜，纯前端打造，资源覆盖国内大部分主流网盘，以及嗅探网络公开分享和TG网盘资源分享频道，一键搜索便可展示所有匹配的资源，且设置了智能缓存和镜像代理加速

*   [Jsnzkpg/email](https://github.com/Jsnzkpg/email) - 裤佬临时邮箱，完全免费无需注册登录，自动加载随机邮箱且可一键更换，邮件不做保留，阅后即焚隐私安全，内置了代理加速保证稳定性

*   [Jsnzkpg/TelegramProxy](https://github.com/Jsnzkpg/TelegramProxy) - 裤佬免费Telegram代理，纯前端制作，甄选网络上公开且优质的免费Telegram代理，进行一个组装，还特意加了tg的唤醒前缀头，一键点击自动跳转到tg进行连接
...
*   [serious-snow/HE-Music-Flutter](https://github.com/serious-snow/HE-Music-Flutter) - HE-Music Flutter版本，主要为移动端
...
*   [nbkieiw/mianfei-tuoguan](https://github.com/nbkieiw/mianfei-tuoguan) - 2025 年最佳免费网站托管服务推荐
...
*   [jurieo/chatgpt-share-web](https://github.com/jurieo/chatgpt-share-web) - chatgpt、claude、midjourney，sora，grok和gemini官网完整还原，以及Claude Code和Codex完整镜像，包含其官网的全部功能。具有完善的用户体系和流量变现体系。
...
*   [zarfadev/Navicat\_Patch\_v17](https://github.com/zarfadev/Navicat_Patch_v17) - This repository provides a simple and effective solution to unlock all premium features of Navicat Premium v17. Follow the included guide to set up the patch and enjoy a seamless database management experience.
...
*   [TransformersWsz/productivity\_tools\_for\_windows](https://github.com/TransformersWsz/productivity_tools_for_windows) - windows 程序员装机必备软件
...
*   [TapXWorld/X-SpringBoot](https://github.com/TapXWorld/X-SpringBoot) - X-SpringBoot是一个轻量级的Java快速开发平台，能快速开发项目并交付【接私活利器】
...
*   [hualin12/tianya](https://github.com/hualin12/tianya) - 很多年前，天涯社区曾出现了不少深受欢迎的帖子，成功地预言了许多形势和事件。这些帖子因此被冠以“天涯神贴”之名。遗憾的是，由于各种原因，天涯论坛目前已经无法打开。幸运的是，有人收集了这些帖子，并将它们整理为一份完整的合集。
...
*   [itgoyo/dm-ticket](https://github.com/itgoyo/dm-ticket) - 大麦网自动购票, 支持docker一键部署。Damai automatically purchases tickets, running in docker container.

*   [lyxlucky/NavicatCracker](https://github.com/lyxlucky/NavicatCracker) - Navicat16 NavicatCracker Navicat pure

*   [shaoyouvip/free](https://github.com/shaoyouvip/free) - 周润发公益免费v2ray节点订阅、翻墙、免费翻墙、免费科学上网、免费节点、免费梯子、免费ss/v2ray/trojan节点、蓝灯、谷歌商店、翻墙梯子、v2ray节点、免费节点、免费v2ray节点、最新公益免费v2ray节点订阅地址、免费v2ray节点每日更新、免费v2ray/clash/singbox节点
...
*   [l-urk/Bat-To-Exe-Converter-64-Bit](https://github.com/l-urk/Bat-To-Exe-Converter-64-Bit) - Bat To Exe Converter (64 Bit) - Developer Fatih Kodak

*   [Demian-Oliveira/Mesto-captcha-buster](https://github.com/Demian-Oliveira/Mesto-captcha-buster) - Captcha solver extension for humans, available for Chrome, Edge and Firefox

*   [ghotst0xdeadbeef/Greenhub-desktop](https://github.com/ghotst0xdeadbeef/Greenhub-desktop) - Greenhub的桌面版，与Greenhub插件一致

*   [rockswang/awesome-java-crawler](https://github.com/rockswang/awesome-java-crawler) - 本仓库收集整理爬虫相关资源，开发语言以Java为主
...
*   [clashv2ray-hub/clashfree](https://github.com/clashv2ray-hub/clashfree) - clash节点、免费clash节点、最新clash免费节点订阅地址、clash免费节点每日更新、免费节点、免费梯子、clash科学上网、clash翻墙、clash订阅链接、clash for Windows、clash教程、免费公益节点、
...
*   [yinmmhh/sb-nodejs](https://github.com/yinmmhh/sb-nodejs) - singbox-nodejs

*   [eishare/tuic-hy2-node.js-python](https://github.com/eishare/tuic-hy2-node.js-python) - tuic hy2-nodejs+python
...
*   [Flikify/Free-Node](https://github.com/Flikify/Free-Node) - 每小时更新最新的Clash、v2ray节点信息
...
*   [wujun728/jun\_k8s\_docker](https://github.com/wujun728/jun_k8s_docker) - 一个拿来即用的docker镜像大礼包，直接构建docker镜像环境(docker、dockerfile、k8s、helm、shell and so on )，Linux运维工具及脚本，K8S构建，各种环境构建部署等，包括不限于于shell、python，运维脚本、docker脚本、各种工具库，收集各类运维常用工具脚本，实现快速安装nginx、mysql、pg、apache、php、redis、tomcat、gcc、gitlib、mq、dfs、k8s、jdk等
...
*   [SmallChi/JT808](https://github.com/SmallChi/JT808) - JT/T808 protocol,JT808 protocol, GB808 protocol (support 2011, 2013, 2019 version)  JT/T808协议、JT808协议、GB808协议(支持2011、2013、2019版本)
...
*   [ageerle/ruoyi-web](https://github.com/ageerle/ruoyi-web) - RuoYi-AI 的用户前端，提供 AI 对话、智能体交互、知识库问答等功能
...
*   [NotoChen/JavaVersionChoice](https://github.com/NotoChen/JavaVersionChoice) - Java厂商/版本切换工具
...
*   [hoochanlon/scripts](https://github.com/hoochanlon/scripts) - 平台：Windows/Mac/Linux。脚本语言：多种、不限；我流，按需编写。涉及：桌面基线排查、软件激活破解、免杀及特权执行、渗透式支援固件识别读写、主机账户密码空值检测、Wi-Fi密码扫描、云主机终端安全加固、主机系统日志分析、自然语言处理、人文社科信息数据分析等。
